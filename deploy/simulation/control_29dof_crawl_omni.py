##
#
# Control node for 29DoF MjLab omnidirectional crawling (G1-Crawling-Omni).
#
##
...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(
        description='Asynchronous Control Node for the MjLab omnidirectional crawling policy.'
    )
