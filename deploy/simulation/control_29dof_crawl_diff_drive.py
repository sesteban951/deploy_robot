##
#
# Control node for 29DoF MjLab differential-drive crawling (G1-Crawling-DiffDrive).
#
##
...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(
        description='Asynchronous Control Node for the MjLab differential-drive crawling policy.'
    )
