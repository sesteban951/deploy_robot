...
def plot_log(file_path: str):
    ...
    # figure 1: joint positions, one subplot per joint (q blue on top, q_des solid black behind)
    ...
    # figure 2: joint velocities, one subplot per joint (dq blue on top, dq_des solid black behind)
    ...
    # figure 3: estimated torque, one subplot per joint
    ...
    # figure 4: IMUs (rows = rpy/quat/gyro/acc, columns = pelvis/torso)
    ...
    # figure 5: joystick command (vx, vy, omega stacked)
...
def main():
    ...
    if args.file is None:
        ...
        print(f"No --file provided, using latest: {file_path}")
    else:
        file_path = args.file
